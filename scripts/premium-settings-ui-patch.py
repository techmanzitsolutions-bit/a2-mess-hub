...
.page-settings{max-width:1120px!important;width:100%!important;min-width:0!important;overflow-x:hidden!important}.settings-hero{display:grid;grid-template-columns:160px minmax(0,1fr);gap:24px;align-items:center;padding:24px!important;width:100%!important;max-width:100%!important;min-width:0!important;overflow:hidden!important}.settings-hero>div{min-width:0!important}.settings-logo{width:140px;height:140px;border-radius:28px;background:linear-gradient(145deg,#0d3427,#061812);border:1px solid rgba(76,227,161,.22);display:grid;place-items:center;overflow:hidden;box-shadow:inset 0 0 32px rgba(77,227,161,.05)}.settings-logo img{width:112px;height:112px;object-fit:contain}.settings-title{font-size:28px;font-weight:900;letter-spacing:-.03em}.settings-tagline{color:var(--muted);font-size:15px;margin-top:4px}.settings-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:18px;width:100%!important;min-width:0!important}.settings-meta>div{padding:12px 14px;border-radius:12px;background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.06);min-width:0!important;max-width:100%!important;overflow:hidden!important}.settings-meta b{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:#8eaaa0;margin-bottom:5px}.settings-meta span{display:block!important;font-weight:750;min-width:0!important;max-width:100%!important;overflow-wrap:anywhere!important;word-break:break-word!important}.settings-list{display:grid;gap:10px;margin-top:14px;min-width:0!important}.settings-item{display:grid;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:14px;padding:15px 16px;border-radius:16px;background:linear-gradient(180deg,rgba(15,45,34,.86),rgba(8,27,20,.92));border:1px solid rgba(94,222,166,.13);box-shadow:0 10px 28px rgba(0,0,0,.13);min-width:0!important;max-width:100%!important;overflow:hidden!important}.settings-item>div{min-width:0!important}.settings-icon{width:46px;height:46px;border-radius:13px;display:grid;place-items:center;background:rgba(53,217,145,.11);font-size:21px}.settings-item strong{display:block;font-size:16px}.settings-item small{display:block;color:var(--muted);margin-top:3px;overflow-wrap:anywhere!important;word-break:break-word!important}.settings-arrow{font-size:26px;color:#aac4b9}.settings-brand{text-align:center;margin-top:14px;padding:20px!important}.settings-brand .crown{font-size:24px}.settings-brand h3{margin:5px 0}.settings-brand .powered{margin:14px 0 0!important}.settings-note{color:var(--muted);font-size:12px;margin-top:6px}
...
@media(max-width:620px){.page-settings{width:100%!important;max-width:100%!important;padding-left:0!important;padding-right:0!important}.settings-hero{grid-template-columns:88px minmax(0,1fr)!important;gap:14px!important;padding:16px!important}.settings-logo{width:88px;height:88px;border-radius:20px}.settings-logo img{width:74px;height:74px}.settings-title{font-size:22px}.settings-tagline{font-size:14px}.settings-meta{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}.settings-meta>div:first-child{grid-column:1/-1!important}.settings-meta>div:last-child{grid-column:auto!important}.settings-meta>div{padding:10px 11px!important}.settings-meta b{font-size:10px!important}.settings-meta span{font-size:14px!important}.settings-item{grid-template-columns:42px minmax(0,1fr) 18px!important;gap:11px!important;padding:13px!important}.settings-icon{width:42px;height:42px}.page-settings .top h2{font-size:30px!important}}
